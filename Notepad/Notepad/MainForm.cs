    ...
    public partial class MainForm : Form
    {
        ...
        private void ItalicTool_Click(object sender, EventArgs e)
        {
            ...
            if (NotePadRichTextBox.SelectionFont.Italic)
            {
                ...
                ItalicTool.Font = new Font(ItalicTool.Font, FontStyle.Regular);
            }
            else
            {
                style |= FontStyle.Italic;
                ItalicTool.Font = new Font(ItalicTool.Font, FontStyle.Bold);
            }
            NotePadRichTextBox.SelectionFont = new Font(NotePadRichTextBox.SelectionFont, style);
            NotePadRichTextBox.Focus();
        }
        ...
        private void UnderlineTool_Click(object sender, EventArgs e)
        {
            ...
            if (NotePadRichTextBox.SelectionFont.Underline)
            {
                ...
                UnderlineTool.Font = new Font(UnderlineTool.Font, FontStyle.Regular);
            }
            else
            {
                style |= FontStyle.Underline;
                UnderlineTool.Font = new Font(UnderlineTool.Font, FontStyle.Bold);
            }
            NotePadRichTextBox.SelectionFont = new Font(NotePadRichTextBox.SelectionFont, style);
            NotePadRichTextBox.Focus();
        }
        ...
        //Событийные методы
        private void FontComboBox_SelectedIndexChanged_1(object sender, EventArgs e)
        {
            switch (FontComboBox.Text)
            {
                ...
                case "Verdana":
                    {
                        Font myfont = new Font("Verdana", Convert.ToByte(SizeComboBox.SelectedItem));
                        NotePadRichTextBox.SelectionFont = myfont;
                        break;
                    }
                case "Georgia":
                    {
                        Font myfont = new Font("Georgia", Convert.ToByte(SizeComboBox.SelectedItem));
                        NotePadRichTextBox.SelectionFont = myfont;
                        break;
                    }
                case "MS Sans Serif":
                    {
                        Font myfont = new Font("MS Sans Serif", Convert.ToByte(SizeComboBox.SelectedItem));
                        NotePadRichTextBox.SelectionFont = myfont;
                        break;
                    }
                default:
        ...
        //Доп.метод для печати
        private void PrintDocumentOnPrintPage(object sender, PrintPageEventArgs e)
        {
            e.Graphics.DrawString(NotePadRichTextBox.Text, NotePadRichTextBox.Font, Brushes.Black, 10, 25);
        }
    }
}
